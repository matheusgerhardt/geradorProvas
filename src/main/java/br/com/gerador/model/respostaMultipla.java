...
@Entity
public class respostaMultipla implements Serializable{
	...
	private Long idRespostaMultipla;
	...
	public Long getIdRespostaMultipla() {
		return idRespostaMultipla;
	}

	public void setIdRespostaMultipla(Long idRespostaMultipla) {
		this.idRespostaMultipla = idRespostaMultipla;
	}
